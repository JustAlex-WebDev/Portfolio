...
const AboutSection = () => {
  ...
  return (
    <div className="w-full relative max-w-[1140px] m-auto px-4 py-72 flex flex-col justify-center items-center gap-16">
      ...
      <div className="absolute top-20 left-20 w-36 h-48 rounded-2xl">
        <img
      ...
      <div className="absolute top-40 right-20 w-36 h-60 rounded-2xl">
        <img
          src="wonderMockup2.jpeg"
          alt=""
      ...
      <div className="absolute bottom-40 left-48 w-36 h-60 rounded-2xl">
        <img
      ...
      <div className="absolute bottom-20 right-48 w-36 h-48 rounded-2xl">
        <img
          src="artconnectionMockup3.jpeg"
          alt=""
